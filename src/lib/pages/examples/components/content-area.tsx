...
import { ParticleGlobeGLDemo } from '@/lib/pages/examples/components/demos/particle-globe-gl/particle-globe-gl';
      ...
      <div className="p-6">
        <div className="overflow-x-auto rounded-xl bg-gray-950 p-6 font-mono text-gray-100 text-sm">
          <div className="mb-4 flex items-center justify-between border-gray-800 border-b pb-3">
            <span className="text-gray-400">particle-globe-gl.tsx</span>
            <Button
              size="sm"
